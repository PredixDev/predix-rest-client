...
public class CFPredixUAAIT
{
    ...
    public void getToken()
    {
        ...
        List<Header> headers = this.restClient.getOauthHttpHeaders(oauthClientId, oauthClientIdEncode);
        String tokenString = this.restClient.requestToken(headers, oauthResource, oauthHost, oauthPort, oauthGrantType, proxyHost,
                proxyPort);
